        ...
        <div className="space-y-6">
          ...
          {activeTab === "banner" && (
            <div className="bg-(--bg-card) border border-(--border) p-5 rounded-2xl space-y-4 shadow-md">
              ...
              <div
                className={`relative rounded-xl p-8 min-h-[220px] flex flex-col justify-center border transition-all duration-300 ${
                  bannerInputs.bgTheme === "obsidian" ? "bg-[#0b0b0b] border-[#222] text-white" :
                ...
                <div className="space-y-4 max-w-md">
                  ...
                  <h2
                    className={`font-display font-black leading-none tracking-tight transition-all duration-300 ${
                      bannerInputs.fontSize === "normal" ? "text-xl sm:text-2xl" :
