...
import {
  ...
  FiAlertCircle, FiTrash2, FiDownload, FiPrinter
} from "react-icons/fi";
import { toast } from "react-toastify";
import { SERVER_URL } from "../services/api";
import { downloadInvoicePDF, printInvoiceHTML } from "../utils/invoicePdf";
...
// Invoice PDF generation is handled by ../utils/invoicePdf.js
...
export default function MyOrders() {
  ...
  const handleDownloadInvoice = async (order) => {
    try {
      ...
      toast.error("Invoice download template rendering error");
    }
  };

  const handlePrintInvoice = (order) => {
    printInvoiceHTML(order, settings);
  };
