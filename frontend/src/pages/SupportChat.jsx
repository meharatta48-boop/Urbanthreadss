...
export default function SupportChat() {
  ...
  return (
    <div className="flex flex-col pt-20 sm:pt-24" style={{ minHeight: "100dvh", background: "var(--bg-deep)" }}>

      {/* Mobile tab switcher */}
      <div className="lg:hidden flex shrink-0 mx-3 sm:mx-5 z-30 rounded-xl overflow-hidden"
